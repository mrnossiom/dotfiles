...
linkFarm "zig-packages" [
  {
    name = "ourio-0.0.0-_s-z0S0XAgB2nng8oxDng5AlACiqMTcFGq77494HMBXw";
    path = fetchgit {
      url = "https://github.com/rockorager/ourio";
      rev = "c94a93d34c0b0082facdabc12b6b997f7ee8b648";
      hash = "sha256-/zsh3l3jCw+AbGw8yCSDTx4EkITCP+yVoDOitTE50M4=";
    };
  }
  {
